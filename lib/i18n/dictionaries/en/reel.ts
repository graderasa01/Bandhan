...
const reel: Record<string, string> = {
  ...
  "reel.feedQuestion.aria": "A question about your profile",
  "reel.feedQuestion.kicker": "Your profile · one question",
  "reel.feedQuestion.whyPreference": "Your preference — the matches you see next are picked with it.",
  "reel.feedQuestion.whySelf": "One tap adds it to your profile. You can change it any time.",
  "reel.feedQuestion.saved": "Saved — added to your profile.",
  "reel.feedQuestion.scrollHint": "Swipe up for the next profile",
  "reel.feedQuestion.skip": "Skip",
  "reel.feedQuestion.next": "Next",
  ...
  "reel.photoGate.formatsMulti": "Pick several at once · JPG, PNG or WEBP · up to 8MB",
  "reel.photoGate.addMore": "Add More",
  "reel.photoGate.remove": "Remove Photo",
  "reel.photoGate.reelNote": "Verified photos join your Reel automatically, up to 4 slides — change the order and notes in My Photos.",
