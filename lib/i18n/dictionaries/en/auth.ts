...
const auth: Record<string, string> = {
  ...
  "register.field.mobileHelp": "This will be your Login ID — or enter your email below",
  ...
  "register.voice.title": "Start your account by speaking",
  "register.voice.subtitle": "Mobile first, then your name. Your password is never taken over the microphone.",
  "register.voice.start": "Start with voice",
  "register.voice.stop": "Stop listening",
  "register.voice.retry": "Speak again",
  "register.voice.heard": "Heard:",
  "register.voice.filled": "Mobile and name filled",
  "register.voice.notSupported": "Voice input is not available in this browser. Type the same details below.",
  "register.voice.micDenied": "Microphone permission was not granted. Type your details below.",
  "register.voice.notHeard": "I could not hear that clearly. Please say it again.",
  "register.voice.mobileAgain": "I could not understand the 10-digit mobile number. Please say it again.",
  "register.voice.nameAgain": "I could not understand your full name. Please say it again.",
  "register.voice.startFailed": "Voice did not start. Please try again.",
  "register.voice.askMobile": "Hello. First, say your 10-digit mobile number one digit at a time.",
  "register.voice.askName": "Got your mobile number. Now tell me your full name.",
  "register.voice.doneSpoken":
    "Your details are filled. Now type a password, or tap the button that creates a strong password.",
  "register.passwordChoice.title": "Password",
  "register.passwordChoice.safe": "Do not say your password aloud — keep it private.",
  "register.passwordChoice.generate": "Create one",
  "register.passwordChoice.generated":
    "A strong password is ready. It will be shown once after your account is created.",
  "register.credentials.title": "Account created",
  "register.credentials.saveOnce": "Save these login details now.",
  "register.credentials.loginId": "Your Login ID",
  "register.credentials.password": "Your Password",
  "register.credentials.private": "Do not share your password. You can change it any time in App Setup.",
  "register.credentials.copy": "Copy Login ID and Password",
  "register.credentials.copied": "Copied",
  "register.credentials.continue": "I've saved it — Continue",

  // Login password settings
  "passwordSettings.title": "Login password",
  "passwordSettings.subtitle":
    "Whether BandhanTak created it or you chose it yourself, you can change your password here any time.",
  "passwordSettings.saved": "Password changed.",
  "passwordSettings.change": "Change password",
  "passwordSettings.set": "Create password",
  "passwordSettings.current": "Current password",
  "passwordSettings.new": "New password",
  "passwordSettings.confirm": "New password again",
  "passwordSettings.help": "At least 8 characters",
  "passwordSettings.mismatch": "The two new passwords are different.",
  "passwordSettings.failed": "Could not change the password.",
  "passwordSettings.save": "Save password",
