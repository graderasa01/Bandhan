...
import { OUTPUT_WIDTH, OUTPUT_HEIGHT } from "./photoEnhance";
 ...
 * are never trusted to already match the Reel's frame, so a final sharp
 * resize enforces the exact same 1200×900 (4:3) contract as `photoEnhance.ts`.
 */
