  ...
  return (
    <UserShell userName={user.fullName}>
      <div className="mx-auto max-w-4xl">
        ...
        {entries.length === 0 ? (
          <EmptyState
            title="Abhi shortlist khaali hai."
            description="Rishta Reel me kisi profile par neeche swipe karein — wo yahan save ho jayegi, taaki aap ghar walon se baat karke baad me faisla kar sakein."
          />
        ) : (
