        ...
        {!chart ? (
          <Card variant="soft" padding="lg">
            <p className="text-[0.9375rem] font-semibold text-ink">
              Kundli ke liye pehle Date of Birth chahiye
            </p>
          ...
          <>
            ...
            <Card variant="luxe" padding="md">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  <h2 className="text-[0.9375rem] font-semibold text-ink">Chandra Rashi</h2>
              ...
              <dl className="mt-4 grid grid-cols-2 gap-2 sm:grid-cols-4">
                {[
                  ["Rashi", chart.chandra.rashiName],
                  ["Nakshatra", chart.chandra.nakshatraName],
                  ["Charan", `${chart.chandra.pada}`],
                  ["Nakshatra swami", chart.chandra.nakshatraLord],
                ].map(([k, v]) => (
            ...
            {chart.lagna ? (
              <Card variant="default" padding="md">
                <div className="flex items-baseline justify-between gap-2">
                  <h2 className="text-[0.9375rem] font-semibold text-ink">Janm Kundli</h2>
                  <span className="text-[0.75rem] text-subtle">
                    Lagna: {chart.lagna.rashiName} {chart.lagna.degreeInRashi.toFixed(0)}°
                ...
                <p className="mt-3 text-center text-[0.6875rem] text-subtle">
                  Uttar Bharatiya shaili · ghar ke andar ka number rashi hai
                </p>
              </Card>
            ) : (
              <Card variant="soft" padding="md">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    <p className="text-[0.9375rem] font-semibold text-ink">
                      {chart.precision === "no-time"
                        ? "Lagna ke liye birth time chahiye"
                        : "Lagna ke liye birth place chahiye"}
                    </p>
            ...
            <Card variant="default" padding="md">
              <h2 className="text-[0.9375rem] font-semibold text-ink">Graha sthiti</h2>
            ...
            <Card
              ...
              padding="md"
            >
              <h2 className="text-[0.9375rem] font-semibold text-ink">Mangal dosh</h2>
              <p className="mt-1 text-[0.8125rem] leading-snug text-muted">
                {chart.manglik.fromLagna === null
                  ? `Lagna ke bina poora nirnay nahi ho sakta. Chandra se dekhein to Mangal ${BHAVA_ORDINAL[chart.manglik.marsHouseFromMoon - 1]} bhav me hai — ${chart.manglik.fromMoon ? "ye manglik shreni me aata hai." : "ye manglik shreni me nahi aata."}`
                  : `Lagna se Mangal ${BHAVA_ORDINAL[(chart.manglik.marsHouseFromLagna ?? 1) - 1]} bhav me hai aur Chandra se ${BHAVA_ORDINAL[chart.manglik.marsHouseFromMoon - 1]} bhav me. ${
                      chart.manglik.fromLagna
                        ? "Lagna ke hisaab se ye manglik shreni me aata hai."
                        : "Lagna ke hisaab se ye manglik shreni me nahi aata."
                    }`}
              </p>
              <p className="mt-2 text-[0.75rem] leading-snug text-subtle">
                Mangal dosh ke kai nivaran (bhang) niyam hain jo poori kundli dekhe bina tay nahi
                hote. Ye sirf sthiti bata raha hai, faisla nahi.
              </p>
            </Card>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    <h2 className="text-[0.9375rem] font-semibold text-ink">
                      Aapke matches ke saath milan
                    </h2>
                    <p className="mt-0.5 text-[0.8125rem] leading-snug text-muted">
                      Sirf un logon ke saath jinse match ho chuka hai. Guna se ye kabhi tay nahi
                      hota ki aapko kaun dikhega.
                    </p>
                  </div>
                </div>
                <ul className="mt-3 divide-y divide-line">
            ...
            <p className="flex items-start gap-1.5 px-1 text-[0.6875rem] leading-snug text-subtle">
              ...
              <span>
                Ganit Lahiri (Chitrapaksha) ayanamsa par hai, Chandra ki sthiti ek arc-minute se
                kam ke antar tak. Ye asli ganit hai — par jyotish aur BandhanTak ki matching do
                alag cheezein hain, aur inme se koi bhi doosre par asar nahi daalta.
              </span>
            </p>
          </>
        )}
