  ...
  return (
    <PartnerShell partnerName={partner.fullName} partnerCode={partnerCode}>
      <div className="mx-auto max-w-2xl">
        <h1 className="text-xl font-bold text-ink">{t("rishtaRoom.partnerRoomsPage.title", "Rishte")}</h1>
        <p className="mt-1 text-[0.875rem] leading-relaxed text-muted">
          {t(
            "rishtaRoom.partnerRoomsPage.intro",
            "Wo rishtey jinme client ne aapko khud jodha hai. Har rishtey me aapko utna hi dikhta hai jitni unhone permission di — chat, unke private note aur mulaqat ke baad ka unka jawaab kabhi nahi.",
          )}
        </p>
        ...
        {rooms.length === 0 ? (
          <div className="mt-4">
            <EmptyState
              title={t("rishtaRoom.partnerRoomsPage.emptyTitle", "Abhi kisi rishtey me nahi jode gaye.")}
              description={t(
                  ...
                  <Card padding="md" className="transition-colors hover:border-gold-400">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <span className="text-[0.8125rem] text-muted">
                        — {r.personName} {t("rishtaRoom.partnerRoomsPage.withSuffix", "ke saath")}
                      </span>
                    </div>
                    ...
                    <p className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-[0.75rem] text-muted">
                      ...
                      {r.pendingRequests > 0 && (
                        <span>
                          {r.pendingRequests} {t("rishtaRoom.partnerRoomsPage.pendingRequestsSuffix", "baat unke jawaab par")}
                        </span>
                      )}
                      {r.nextMeetingAt && (
