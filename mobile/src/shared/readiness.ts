// GENERATED from lib/profile/readiness.ts by mobile/scripts/sync-catalog.ts — do not edit.
...
import { FIELD_BY_KEY, PROFILE_FIELDS, type ProfileFieldDef, type ProfileValues } from "~/catalog/fields";
