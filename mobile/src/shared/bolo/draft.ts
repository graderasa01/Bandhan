// GENERATED from lib/bolo/draft.ts by mobile/scripts/sync-catalog.ts — do not edit.
...
import { FIELD_BY_KEY, type ProfileFieldDef } from "~/catalog/fields";
import { MINIMUM_LIVE_FIELDS, MINIMUM_LIVE_KEYS, isValidFieldValue } from "~/shared/readiness";
