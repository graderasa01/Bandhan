...
import { PLAN_COMPARISON_ROWS, PLAN_NAMES, PLAN_ORDER, type ComparisonValue } from "@/lib/constants/plans";
 ...
 */
export default function PlanComparisonTable({ prices, recommendedCode = "STANDARD" }: Props) {
  return (
