...
export const ADMIN_NAV_GROUPS: AdminNavGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Growth Saathi",
        icon: Rocket,
        blurb: "AI marketing manager — goal do, Google/Meta/Reel campaign package lo.",
        keywords: "marketing ai campaign ads google meta instagram reels keywords analytics search console growth saathi package approval",
      },
    ],
  },
  {
